...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/smartblock-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/smartblock-cli.cpp \
           src/smartblock-tx.cpp \
           src/smartblock.cpp \
           src/db.cpp \
           ...
           src/qt/smartblock.cpp \
           src/qt/smartblockstrings.cpp \
...
RESOURCES += src/qt/smartblock.qrc src/qt/smartblock_locale.qrc

TRANSLATIONS += src/qt/locale/smartblock_bg.ts \
                src/qt/locale/smartblock_de.ts \
                src/qt/locale/smartblock_en.ts \
                src/qt/locale/smartblock_es.ts \
                src/qt/locale/smartblock_fi.ts \
                src/qt/locale/smartblock_fr.ts \
                src/qt/locale/smartblock_it.ts \
                src/qt/locale/smartblock_ja.ts \
                src/qt/locale/smartblock_pl.ts \
                src/qt/locale/smartblock_pt.ts \
                src/qt/locale/smartblock_ru.ts \
                src/qt/locale/smartblock_sk.ts \
                src/qt/locale/smartblock_sv.ts \
                src/qt/locale/smartblock_vi.ts \
                src/qt/locale/smartblock_zh_CN.ts \
                src/qt/locale/smartblock_zh_TW.ts
