...
This means one can have an always-on smartblockd instance running, and another local smartblockd/smartblock-qt instance which connects to this node and receives blocks from it.
