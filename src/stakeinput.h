...
#ifndef SMARTBLOCK_STAKEINPUT_H
#define SMARTBLOCK_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZXCK() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zXCKStake can take two forms
// 1) the stake candidate, which is a zcmint that is attempted to be staked
// 2) a staked zxck, which is a zcspend that has successfully staked
...
public:
    ...
    bool IsZXCK() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZXCK() override { return false; }
};


#endif //SMARTBLOCK_STAKEINPUT_H
