...
/* SmartBlock GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "SMARTBLOCK"
#define QAPP_ORG_DOMAIN "smartblock.org"
#define QAPP_APP_NAME_DEFAULT "SMARTBLOCK-Qt"
#define QAPP_APP_NAME_TESTNET "SMARTBLOCK-Qt-testnet"
