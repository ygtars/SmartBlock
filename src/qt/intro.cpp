...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("SMARTBLOCK Core"),
     ...
     * override -datadir in the smartblock.conf file in the default data directory
     * (to be consistent with smartblockd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
