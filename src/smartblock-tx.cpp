...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("SmartBlock Core smartblock-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  smartblock-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded smartblock transaction") + "\n" +
                               "  smartblock-tx [options] -create [commands]   " + _("Create hex-encoded smartblock transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded smartblock transaction
