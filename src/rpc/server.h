...
/**
 * SMARTBLOCK RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzxckseed(const UniValue& params, bool fHelp);
extern UniValue getzxckseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzxck(const UniValue& params, bool fHelp);
extern UniValue dzxckstate(const UniValue& params, bool fHelp);
