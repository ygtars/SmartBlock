...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop SMARTBLOCK server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "SMARTBLOCK server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* SMARTBLOCK features */
        {"smartblock", "masternode", &masternode, true, true, false},
        {"smartblock", "listmasternodes", &listmasternodes, true, true, false},
        {"smartblock", "getmasternodecount", &getmasternodecount, true, true, false},
        {"smartblock", "masternodeconnect", &masternodeconnect, true, true, false},
        {"smartblock", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"smartblock", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"smartblock", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"smartblock", "masternodecurrent", &masternodecurrent, true, true, false},
        {"smartblock", "masternodedebug", &masternodedebug, true, true, false},
        {"smartblock", "startmasternode", &startmasternode, true, true, false},
        {"smartblock", "createmasternodekey", &createmasternodekey, true, true, false},
        {"smartblock", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"smartblock", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"smartblock", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"smartblock", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"smartblock", "getmasternodescores", &getmasternodescores, true, true, false},
        {"smartblock", "mnbudget", &mnbudget, true, true, false},
        {"smartblock", "preparebudget", &preparebudget, true, true, false},
        {"smartblock", "submitbudget", &submitbudget, true, true, false},
        {"smartblock", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"smartblock", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"smartblock", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"smartblock", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"smartblock", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"smartblock", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"smartblock", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"smartblock", "checkbudgets", &checkbudgets, true, true, false},
        {"smartblock", "mnsync", &mnsync, true, true, false},
        {"smartblock", "spork", &spork, true, true, false},
        {"smartblock", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzxckseed", &getzxckseed, false, false, true},
        {"zerocoin", "setzxckseed", &setzxckseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzxck", &searchdzxck, false, false, true},
        {"zerocoin", "dzxckstate", &dzxckstate, false, false, true}
...
{
    return "> smartblock-cli " + methodname + " " + args + "\n";
}
