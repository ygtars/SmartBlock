...
This mechanism has been integrated into Bitcore-Node-SMARTBLOCK which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/SMARTBLOCK-Project/insight-api-smartblock#web-socket-api](https://github.com/SMARTBLOCK-Project/insight-api-smartblock#web-socket-api) 
* API: [https://github.com/SMARTBLOCK-Project/insight-api-smartblock#swifttx-transactions](https://github.com/SMARTBLOCK-Project/insight-api-smartblock#swifttx-transactions) 
...
By default, the SMARTBLOCK Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the SMARTBLOCK Core daemon:
