Contributing to SMARTBLOCK Core
============================

The SMARTBLOCK Core project operates an open contributor model where anyone is
...
The following applies to code changes to the SMARTBLOCK Core project, and is not to be
confused with overall SMARTBLOCK Network Protocol consensus changes.

Whether a pull request is merged into SMARTBLOCK Core rests with the project merge
...
Patches that change SMARTBLOCK consensus rules are considerably more involved than
...
Where a patch set proposes to change the SMARTBLOCK consensus, it must have been
...
The project leader is the release manager for each SMARTBLOCK Core release.
