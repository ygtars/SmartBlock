...
#   c) node1 mines 32 blocks, so now node 0 has 60001xck, node 1 has 4250xck, node2 has none.
#   d) node0 sends 601 xck to node2, in two transactions (301 xck, then 300 xck).
